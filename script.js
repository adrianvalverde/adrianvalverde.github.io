...
function search(){
  ...
  document.getElementById("results2").innerHTML = "<font color = red>Use this only as a quick guide, the referring provider may order contrast differently.</font color>";
  }else{
  ...
  document.getElementById("results").innerHTML = "<br>with and without <font color=red>iv contrast</font color>-<font color=blue> no oral contrast</font color>"; 
    ...
    if (action > 74&&action <=140){
      ...
      document.getElementById("results").innerHTML = "<br>This is likely an arthrogram.";
         document.getElementById("results2").innerHTML = "<font color = red>Please confirm with the referring physician.</font color>";
       }else{
...
function ivcon() {
    document.getElementById("results").innerHTML = "<br><br><br><br><br><br>IV Contrast or Intravenous <i>(injected in the veins)</i> is a fluid used to highlight the veins and arteries inside the patient. It also illuminates the tissue of organs, so it is regularly used for most exams.";
}

document.getElementById("oralcontrast").onclick = function() {pocon()}
function pocon() {
    document.getElementById("results").innerHTML = "<br><br><br><br><br><br>Oral contrast <i>(taken by mouth) </i> is a fluid used to hightlight the digestive tract inside a patient. It follows the path of digestion from mouth to colon, so it is used in any abdominal or pelvis studies. Oral Contrast is not used to enhance any other organ.";
}